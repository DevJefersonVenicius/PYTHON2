class BombaGasolina:
  ...
  def set_tipo_combustivel(self):
    ...
    while self.set_tipo_combustivel:
        ...
        if self.tipo_combustivel == 'alcool':
           ...
           print('Você digitou um tipo de combustível inválido. Digite novamente.')
  ...
  def abastecer_litro(self):
    ...
    if litro > self.quantidade_combustivel:
      print(f'Quantidade de litros insuficiente. A quantidade de litros da bomba é {self.quantidade_combustivel} litros')    
      self.abastecer_litro()
